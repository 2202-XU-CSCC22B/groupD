  ...
  return (
    ...
    >
      <MyContainer className="grid place-items-center h-[calc(100vh-74px)]">
        <div className={`${styles.carouselContainer} flex justify-center items-center`}>
          <Carousel
        ...
        <div className="bg-white p-4 rounded-lg mt-8 text-center">
          ...
          <p className="text-lg text-gray-500 mb-2">2nd Floor, Forever Books Bldg., Bulua Highway, Cagayan de Oro, Philippines</p>
          <div className="flex items-center justify-center">
            <FacebookRoundedIcon className="text-gray-500 mr-2" style={{ fontSize: "24px", marginBottom: "-2px" }} />
            <a href="https://facebook.com/unscthdfitness" className="text-lg text-gray-500 hover:underline" target="_blank" rel="noopener noreferrer">
              facebook.com/unscthdfitness
            </a>
          </div>
          <div className="flex items-center justify-center mt-2">
            <ContactPhoneRoundedIcon className="text-gray-500 mr-2" style={{ fontSize: "24px", marginTop: "-1px" }} />
